...
import './ExampleResultsPage.css';
import HistoricalMarketDataChart from './Chart.js'; 

const ExampleResultsPage = () => {
  return (
    <div className="example-results-page"> 
      <header className="example-results-header"> 
...
export default ExampleResultsPage;